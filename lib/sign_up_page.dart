...
class SignUpPage extends StatefulWidget {
  ...
  const SignUpPage({Key? key, required this.onSignUp, required this.onBack}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Sign Up', style: TextStyle(color: Colors.green[900])),
        leading: IconButton(
              ...
              child: Padding(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Create Account', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.green[900])),
                      SizedBox(height: 24),
                      TextFormField(
